...
<div id="hmm">
  ...
  <div id="modal" /> <!-- An empty div for shenanagins involving le funny messageAction -->
...
<Card class="bg-[#222] text-white">
	...
	<CardContent class="grid gap-4">
      ...
      <Button variant="outline" class="bg-slate-950" on:click={loginWithWebauthn}>
    ...
    <Button variant="outline" class="bg-slate-950" on:click={switchToCreateAccount}>
        Switch to creating account
		</Button>
		...
		<div class="relative">
			...
			<div class="relative flex justify-center text-xs uppercase">
				<span class="bg-[#222] px-2 text-muted-foreground text-white">
					Or continue with
				</span>
			</div>
		</div>
